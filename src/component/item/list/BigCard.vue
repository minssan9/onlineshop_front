  ...
  <div class="col-4 col-lg-3 text-center mb-5">
    <div class="card-item card">
      ...
      <div class="card-body">
        ...
        <p class="card-text">
          <s>{{ item.price }}원</s> <strong> {{ total }}원</strong>
        </p>
        <span class="badge-md badge badge-danger"> BEST </span>
        <!-- <span class="badge-md badge badge-primary"> 주문폭주 </span> -->
        <!-- <span class="badge-md badge badge-warning"> 총알배송 </span> -->
      </div>
    </div>
  </div>
</template>
